...
xst -ifn xst.scr
move uart_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\uart_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc uart_exdes.ucf uart_exdes

echo 'Running map'
map -timing uart_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm uart_exdes -w routed.ncd routed.v
cd ..
