...
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax uart_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.uart_tb work.glbl
